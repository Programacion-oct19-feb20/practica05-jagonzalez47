...
public class OperadoresAritmeticos {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("División: %d / %d = %d\n", valorA, valorB,
                valorA / valorB); // para sacar el residuo de una division en 
                                 //netbeans y python, no utilizamos la "/" 
                                 //normal si no utilizamos "%" como division
                                 //para tener el residuo.
        
       
        System.out.printf("Division Dos: %d / %d = %.2f\n", valorA, valorB, divisionDos);
